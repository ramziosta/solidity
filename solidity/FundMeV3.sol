...
// makwes a red button because its payable
    ...
    modifier onlyOwner() {
        ...
        // this is executed after the requier is met
        // if it wasw the other way around it will execute the function
...
// makes orange button
    function withdrawAllMoney() public onlyOwner {
        ...
        require(sendSuccess, "Send was not successfull");

        (bool callSuccess, ) = payable(msg.sender).call{
            value: address(this).balance
        }("");
        require(callSuccess, "Call was not successfull");
    }
